          ...
          <main style={{minHeight:'100vh',background:'#000000',display:'flex',alignItems:'center',justifyContent:'center',padding:'32px 16px'}}>
                  <div style={{width:'100%',maxWidth:'420px'}}>
                            <div style={{textAlign:'center',marginBottom:'28px'}}>
                                        <div style={{fontFamily:'Ruthie,cursive',fontSize:'2.2rem',color:'#7BC906'}}>studio 2.5</div>div>
                                        <div style={{fontFamily:'Hedvig Letters Serif,serif',fontSize:'13px',color:'rgba(255,255,255,0.45)'}}>advisor request access</div>div>
                            </div>div>
                            <SignUp routing="hash"
                                        appearance={{elements:{
